            ...
            <Route exact path="/moderation" render={props => (
              <React.Fragment>
                ...
                <div className="Cont">
                  ...
                  <NavLink className="link" to="/moderation/Moderators" >Moderators</NavLink>
...
The moderation log will also list actions taken by Automoderator if it is set up to make actions on your profile</p> */}
                  ...
                  <NavLink className="link" to="/moderation/ModerationQueue">ModerationQueue</NavLink>
                  <p className="par">Content that users report can be found here so you can approve or remove it.</p>


                  <NavLink className="link" to="/moderation/BanUsers">BanUsers</NavLink>
...
You can approve content that was removed accidentally.</p> */}
            ...
            <Route path="/moderation/ModerationQueue" component={ModerationQueue} />
            <Route path="/moderation/Moderators" component={Moderators} />
            <Route path="/moderation/BanUsers" component={BanUsers} />
          </div>
        </div>
      </Aux>
    </Router>
